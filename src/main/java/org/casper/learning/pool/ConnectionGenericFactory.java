 ...
 * @author Casper
 */
public class ConnectionGenericFactory implements KeyedPooledObjectFactory<String, Connection> {
    ...
    public PooledObject<Connection> makeObject(String s) throws Exception {
        return new PooledObject() {
            ...
            @Override
            public int compareTo(PooledObject pooledObject) {
                return 0;
            }
            ...
            @Override
            public boolean endEvictionTest(Deque deque) {
                return false;
            }
        };
    }
